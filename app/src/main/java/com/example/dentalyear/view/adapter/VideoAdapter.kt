...
class VideoAdapter(private var data: List<VideoModel>? = null): RecyclerView.Adapter<VideoAdapter.VideoViewHolder>() {
    ...
    override fun onBindViewHolder(holder: VideoViewHolder, position: Int) {
        holder.videoTitleTextView.text = data?.get(position)?.videoTitle
        holder.durationTextView.text = data?.get(position)?.videoDuration
    }
